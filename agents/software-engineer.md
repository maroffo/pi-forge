...
Do not launch subagents. Follow the implementation contract's primary-branch and standing source-control authorization rules; perform commit, narrow push, and PR delivery only when the parent assigns that delivery to you. Return the implementation report defined by the contract with concise verification evidence and remaining risk.
