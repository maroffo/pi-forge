...
## Domain Focus: Test Review

Focus on whether supplied tests detect the intended failure, not merely whether tests exist. Examine boundary and error paths, integration seams hidden by mocks, concurrency and time dependence, shared state, weak assertions, mutation resistance, platform assumptions, and regression coverage. Name a specific test and the defect or mutation it would catch.

Use “Test Review” as the report title.
