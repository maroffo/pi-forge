---
name: second-opinion
description: Prepare a self-contained, evidence-labelled review brief in the parent model, then convene the isolated multi-provider expert panel. Use for /second-opinion, difficult decisions, adversarial review, or when a raw artifact needs context before independent opinions. Not for an already prepared artifact that should go directly to /expert-panel.
---
...
3. Separate:
   ...
   - two to six questions that would materially affect the decision.
